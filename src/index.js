...
router.route('/teacher/process/fetchFullHistory').post(function (req, res) {
    History.findOne({
        _id: req.body.id
    }, (err, data) => {
        if (err) throw err;
...
router.route('/teacher/process/fetchLessons').post(function (req, res) {
    Schedules.find({
        day: req.body.day,
        disabled: false
    }, (err, data) => {
...
router.route('/teacher/process/fetchLesson').post(function (req, res) {
    Lessons.findOne({
        userId: req.body.id
    }, (err, data) => {
        if (err) throw err;
...
router.route('/teacher/process/saveLesson').post(function (req, res) {
